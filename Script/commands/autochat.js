...
module.exports.config = {
  ...
  version: "4.0.0",
  hasPermssion: 2,
  credits: "PRIME SHUVO (edited by Ferdous)",
...
const keywordList = [
  ...
  { keywords: ["admin", "admin ke?", " বট কার", "bot kar", "admin ke", "kar bot"], reply: "Admin/Owner: স্বপ্নের রাজকুমার 💜✨. 𝚃𝚢𝚙𝚎 𝙰𝚍𝚖𝚒𝚗 𝚏𝚋 𝚏𝚘𝚛 𝚏𝚊𝚌𝚎𝚋𝚘𝚘𝚔 𝚕𝚒𝚗𝚔 & 𝙰𝚍𝚖𝚒𝚗 𝚒𝚗𝚜𝚝𝚊 𝚏𝚘𝚛 𝚑𝚒𝚜 𝚒𝚗𝚜𝚝𝚊𝚐𝚛𝚊𝚖 𝚊𝚌𝚌𝚘𝚞𝚗𝚝..! 😉💜" },
  ...
  { keywords: ["vag", "vago"], reply: "Dhur ho tui 🫩" },
  { keywords: ["sigma", "chad"], reply: "🗿✨" },
  { keywords: ["nigga"], reply: "🌚" },
  ...
  { keywords: ["Admin insta"], reply: "https://www.facebook.com/SHUVOHASSAN66" },
  ...
  { keywords: ["chup", "chop", "চুপ"], reply: "Tui chup kor 🤫" }
];
